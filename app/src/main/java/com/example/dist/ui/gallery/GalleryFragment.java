package com.example.dist.ui.gallery;
...
import com.example.dist.adaptador.RecyclerAdapterUsuarios;
import com.example.dist.databinding.FragmentGalleryBinding;

import com.example.dist.model.ItemListUsuarios;
import com.example.dist.retrofitdata.RetrofitApiServiceUsuarios;
import com.example.dist.retrofitdata.RetrofitClientUsuarios;
...
public class GalleryFragment extends Fragment implements RecyclerAdapterUsuarios.RecyclerItemClick, SearchView.OnQueryTextListener {

    private FragmentGalleryBinding binding;
    private RecyclerView rvLista;
    private SearchView svSearch;
    private RecyclerAdapterUsuarios adapter;
    private List<ItemListUsuarios> items;
    private RetrofitApiServiceUsuarios retrofitApiServiceUsuarios;
    private View root;
    ...
    private void initValues() {
        retrofitApiServiceUsuarios = RetrofitClientUsuarios.getApiService();
    ...
    private void getItemsSQL() {
        retrofitApiServiceUsuarios.getItemsDB().enqueue(new Callback<List<ItemListUsuarios>>() {

            @Override
            public void onResponse(Call<List<ItemListUsuarios>> call, Response<List<ItemListUsuarios>> response) {
                items = response.body();
                adapter = new RecyclerAdapterUsuarios(items, GalleryFragment.this);
                rvLista.setAdapter(adapter);
            }

            @Override
            public void onFailure(Call<List<ItemListUsuarios>> call, Throwable t) {
                Toast.makeText(getContext(), "Error: "+t.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
    }
    @Override
    public void itemClick(ItemListUsuarios item) {
