...
import com.example.dist.databinding.ActivityMenuPrincipalBinding;

public class menuPrincipal extends AppCompatActivity implements iComunicaFragments {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_inicio, R.id.nav_usuarios, R.id.nav_clientes,R.id.nav_transporte,R.id.pedido)
